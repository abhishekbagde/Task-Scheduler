...
import com.abhishek.taskscheduler.payment.AddEditPaymentActivity;
...
public class PaymentAdapter extends BaseAdapter {
    ...
    public PaymentAdapter(Context context, ArrayList<TaskModel> taskList) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (i == 0) {
            ...
            tv_taskname.setText("Add Custom");
        } else {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (i != 0) {
                    intent.putExtra("Payment", taskList.get(i - 1));
                }
